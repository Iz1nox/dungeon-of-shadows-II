  ...
  list: [
    {
      ...
      diff: { hp: 1.7, atk: 1.4 },   // mnożnik trudności krainy
      deco: ['🪦', '🦴', '💀', '🕸️', '⚰️'],
    ...
    },
    {
      ...
      diff: { hp: 1.35, atk: 1.22 },   // mnożnik trudności krainy
      deco: ['🍄', '🌿', '🪨', '🍄‍🟫', '🌱'],
    ...
    },
    {
      ...
      diff: { hp: 1.08, atk: 1.05 },   // mnożnik trudności krainy
      deco: ['🧊', '❄️', '🪨', '⛄', '🌨️'],
    ...
    },
    {
      ...
      diff: { hp: 1, atk: 1 },   // mnożnik trudności krainy
      deco: ['🌋', '🔥', '🪨', '💀', '🕯️'],
